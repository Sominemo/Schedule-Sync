...
class apiException extends Exception {
    ...
    */
     ...
     * 
     * @example "inc/classes/User.php" 33 4 The Exception could be throwed by statements
     * @example methods/Users/Get.php 15 7 Catching an exception to do other tasks
     * 

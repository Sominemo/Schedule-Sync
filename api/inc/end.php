...
if (!is_array($the_return_stream)) {
    $the_return_stream = '{"error_code": 100, "info": "Something went wrong"}';
}
...
// Else convert it to JSON
    ...
    $the_return_stream = json_encode($the_return_stream, JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES);
}
